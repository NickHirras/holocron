# Holocron Developer Guide

Welcome to the Holocron Developer Guide! This document provides all the technical details you need to understand, build, test, and contribute to the Holocron project.

## 🏗️ Architecture & Tech Stack

Holocron uses a **Contract-First Monorepo Architecture**, heavily inspired by internal Google engineering standards. Protocol Buffers act as the ultimate Source of Truth. The schema dictates the backend data classes, the frontend TypeScript interfaces, and the network transport layer.
...
## 🔐 12-Factor Federated Authentication (Local Dev)
...
3. **Implement:** 
   * Open your Kotlin IDE; the new field will instantly be available in the generated Data Classes.
